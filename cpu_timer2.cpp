...
const int places = 6;
const std::string spec("%t sec CPU, %w sec real");
...
int main()
{
  ...
  for (long n = 0; n < 10; ++n) {
    ...
    cout << format(elapsed_times, places, spec) << endl;
    cout << std::setw(8)
         << elapsed_times.user+elapsed_times.system << " ns  CPU, "
         << std::setw(8)
         << elapsed_times.wall << " ns  real" << endl;
