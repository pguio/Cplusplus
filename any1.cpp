...
int main()
{
  ...
  values.insert(anyPair(1,double(2.0)));
  values.insert(anyPair(2,std::string("hello")));
  values.insert(anyPair(3,int(100)));
  values.insert(anyPair(4,bool(false)));
  values.insert(anyPair(5,vectbool));
